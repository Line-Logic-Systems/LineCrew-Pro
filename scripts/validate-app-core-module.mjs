...
for (const name of ['uniqueOfflineJsaJobs','offlineJsaNetworkFailure']) {
...
for (const signature of ['function uniqueOfflineJsaJobs(jobs){','function offlineJsaNetworkFailure(error){']) {
