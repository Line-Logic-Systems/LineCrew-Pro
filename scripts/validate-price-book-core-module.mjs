...
const helperNames = ['normalizeImportHeader','importEditDistance','importHeaderMatchConfidence','normalizedPriceWorkType','importCell','importPrice','numericImportPrice','spreadsheetColumnName','priceBookComparisonValueChanged'];
...
console.log('- import parsing, prices, spreadsheet columns, and comparison-value behavior match legacy behavior');
