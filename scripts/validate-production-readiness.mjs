...
assert(
  index.includes('expanded-jsa.js?v=20260907b') &&
    ...
    serviceWorker.includes("linecrew-pro-shell-v99") &&
...
assert((index.match(/const totalHours =/g) || []).length === 3, 'All production run-rate paths must use total actual hours.');
...
for (const marker of [
  ...
  "otherSummary.textContent = 'Other Actions'",
  "dangerZone.className = 'job-danger-zone'",
  "packageTitle.textContent = 'Utility Job Packages'",
  "addPackageButton.textContent = '+ Add Job Packet'"
