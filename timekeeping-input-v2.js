...
(() => {
  ...
  function installEquipmentManager(){
    ...
    box.classList.toggle('hidden',(window.LineCrewTimekeepingTabs?.active?.()||'roster')!=='equipment');
